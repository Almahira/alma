    ...
    try {
        ...
        if (!nc || nc.isClosed()) {
            alerts.push({
                ...
                message: "Antrean sinkronisasi transaksi tidak dapat mendistribusikan data.",
                timestamp: new Date().toISOString(),
            });
        }
        ...
        const recentErrors = await db
            ...
            .where(sql `${telemetryMetrics.metricName} LIKE '%ERROR%' OR ${telemetryMetrics.metricName} LIKE '%CRASH%'`)
