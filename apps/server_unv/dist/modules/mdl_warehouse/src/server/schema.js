...
import { pgTable, text, varchar, boolean, timestamp, integer, jsonb, doublePrecision, // <--- TAMBAHKAN TIPE DOUBLE PRECISION
...
export const warehouseStockOpnameItems = pgTable("warehouse_stock_opname_items", {
    id: text("id").primaryKey(),
