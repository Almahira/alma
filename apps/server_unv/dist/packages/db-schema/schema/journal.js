...
export const systemEventJournal = pgTable("system_event_journal", baseJournalColumns, (t) => ({
...
export const txEventJournal = pgTable("tx_event_journal", baseJournalColumns, (t) => ({
