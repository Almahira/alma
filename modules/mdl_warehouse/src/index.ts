  ...
  registerValidationRules: () => [
    {
      ...
      targetAggregate: "WAREHOUSE_DOCUMENT",
      collectionKey: "recipes",
      matchFields: ["name"],
      scopeBy: ["companyId"],
      errorMessage: "Resep menu dengan nama ini sudah ada di buku resep!",
    },
    {
      ...
      matchFields: ["name"],
      scopeBy: ["companyId"],
      errorMessage: "Nama resep tersebut sudah digunakan pada resep lain!",
    },
  ],
